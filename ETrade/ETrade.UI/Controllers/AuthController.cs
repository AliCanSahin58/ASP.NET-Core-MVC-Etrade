    ...
    public class AuthController : Controller
    {
        ...
        public IActionResult Register(UsersModel? model)
        {
            ...
            else
            {
                ...
                _uow.Commit();
                return RedirectToAction("Success", "Home", new { Msg = $"{model.User.Mail} adlı kullanıcı girişi başarılı !!" }); // Sadece index yazarsam bu sayfada index arar. Başka bir controllerdaki indexe gitmek istersem virgülden sonra gideceğim kontrollerin adını yazarız.
            }
        }
